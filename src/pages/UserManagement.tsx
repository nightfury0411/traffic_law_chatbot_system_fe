...
export default function UserManagementPage() {
  ...
  const createUser = (userData) => handleApiCall(async () => {
  ...
  const updateUser = (id, userData) => handleApiCall(async () => {
      ...
      <div className="min-h-screen bg-gray-50 p-6 transition-colors duration-300">
        <div className="">
          ...
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600">Create, view, and manage system users with ease.</p>
          </div>
